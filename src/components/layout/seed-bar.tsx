...
export function SeedBar() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 z-40 max-w-3xl -translate-x-1/2 rounded-2xl border border-flora-border bg-white/80 shadow-lg backdrop-blur-md">
      <div className="flex gap-2 overflow-x-auto overscroll-x-contain py-2.5 scrollbar-hide before:shrink-0 before:w-2 before:content-[''] after:shrink-0 after:w-2 after:content-['']">
